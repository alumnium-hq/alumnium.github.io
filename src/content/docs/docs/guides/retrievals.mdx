...
<LanguageContent lang="python">If the data is not present on the page, Alumnium returns `None`:</LanguageContent>
...
<video
  class="rounded-xl"
  alt="A screen recording of Alumnium returning null for data not present on the page"
  controls
  controlslist="nofullscreen"
  disablepictureinpicture
  muted
