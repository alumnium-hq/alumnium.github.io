...
```typescript
await al.check("'buy milk' title font style is strikethrough", { vision: true });
```
...
<video
  class="rounded-xl"
  alt="A screen recording of Alumnium failing to determe font style of completed task"
  controls
  controlslist="nofullscreen"
  disablepictureinpicture
  muted
