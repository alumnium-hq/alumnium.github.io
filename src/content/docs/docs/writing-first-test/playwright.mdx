...
:::note
Alumnium can be used with any test runner you like. For the examples in this guide, we'll use a default Playwright test runner.
:::

## Install Dependencies

Make sure you have Alumnium in your project.
...
We'll also need to install Docker to run the Alumnium server. Please, refer to [Docker installation guide][4] for your platform.
